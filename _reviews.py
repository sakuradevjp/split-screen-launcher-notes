...
REVIEWS = [
...

    {
        ...
        "date": _date(2026, 6, 8),
        "original_lang": "en",
        "original_text": "good working without any ads",
        "translations": {
            "ja":    "広告なしでちゃんと動く。",
            "ko":    "광고 없이 잘 작동해요.",
            "zh-CN": "没有广告，运行良好。",
            "zh-TW": "沒有廣告，運作良好。",
            "es":    "Funciona bien y sin anuncios.",
            "pt-BR": "Funciona bem e sem anúncios.",
            "fr":    "Fonctionne bien, sans aucune pub.",
            "de":    "Läuft gut, ganz ohne Werbung.",
            "it":    "Funziona bene, senza pubblicità.",
            "ru":    "Работает хорошо, без рекламы.",
            "ar":    "يعمل جيدًا وبدون أي إعلانات.",
            "hi":    "बिना किसी विज्ञापन के अच्छे से चलता है।",
            "th":    "ใช้งานได้ดี ไม่มีโฆษณา",
            "vi":    "Chạy tốt, không có quảng cáo.",
        },
    },
